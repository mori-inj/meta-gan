...
gen_weight_size = [16, 16, 784] #[16, 64, 784]
weight_size = 0
...
def generator(z, reuse = False):
    l = [random_size, 2048, 4096, weight_size]
...
with tf.Session(graph = g) as sess:
    ...
    for epoch in range(total_epochs):
        ...
        f = open('./epoch_/epoch'+str(epoch)+'.txt','w')
        for _ in range(10):
            ...
            gen_output = np.ndarray.tolist(np.reshape(gen_output,(784)))
            cnt = 0
            # sample_out = ""
        ...
        save_path = saver.save(sess, "./meta-gan"+".ckpt")
